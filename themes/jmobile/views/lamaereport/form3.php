<?php if (Yii::app()->session["username"] != null) { ?>
    <div class="panel" style="margin-left: 10px;">
        ...
        <div class="ui-body ui-body-b ui-corner-all">
            ...
            <div>
                <?php echo CHtml::button("ค้นหา", array
					('title' => 'ค้นหา',
					'data-theme' => 'b',
					'onclick' => 'url()')); ?>
...
<script language="javascript">
    ...
    function url() {
        ...
        window.open('http://192.168.1.252/ireport/themes/jmobile/views/lamaereport/stimulrep/stimulsoft//index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=<?= $point; ?>.mrt&datestart=' + datestart );
    }
